jQuery(document).ready(function () {
    ...
    $(".js-choice").change(function () {
        $('.email_error').empty();
        $('.pass_error').empty();
        $('.company_name_p_error').empty();
        $('.company_name_error').empty();
        $('.name_error').empty();
        $('.agree_error').empty();
        $('.message_send').empty();
        var selectedValue = $(this).val();
        if (selectedValue === 'advertiser') {
                ...
                success: function (response) {
                    ...
                    if (response.status == 'error') {
                        $.each(response.data_error, function (index, value) {
                            if (value == 'Email is not correct') {
                                var targetElement = $('.email_error');
                            ...
                            if (value == 'Company name / Freelance name field is empty') {
                                var targetElement = $('.company_name_p_error');
                                var newDiv = $('<p style="color: red">' + value + ' </p>');
                                targetElement.append(newDiv);
                            }
                            if (value == 'Company name field is empty') {
                                var targetElement = $('.company_name_error');
                                var newDiv = $('<p style="color: red">' + value + ' </p>');
                                targetElement.append(newDiv);
                            }
                            if (value == 'Name field is empty') {
